...
class MLPlay:
    ...
    def update(self, scene_info: dict, keyboard: list = [], *args, **kwargs):
        ...
        rf=scene_info["R_sensor"]*0.5+scene_info["R_T_sensor"]*1.2
        lf=scene_info["L_sensor"]*0.5+scene_info["L_T_sensor"]*1.2
        ff=scene_info["F_sensor"]

        self.control_list["right_PWM"]=300/rf-rf/3+ff
        self.control_list["left_PWM"]=300/lf-lf/3+ff
